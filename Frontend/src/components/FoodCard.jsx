      ...
      <div className=''>
        ...
        <div className='flex flex-1 flex-col  px-3  w-full absolute left-0 bottom-0 bg-opacity-95 bg-[#ffffff96] rounded-b-xl text-small 
          ...
          <div className='flex items-center justify-between aligns-center pb-2'>
            ...
            <div className='bg-white text-black rounded-2xl gap-4  overflow-hidden shadow-sm  border'>
              ...
              <button className={`${ CardItems.some(i=>i._id == data._id)?"text-white bg-gray-800 p-2":"text-white bg-[#ff4d2d] p-2"} `}  onClick={()=> quantity > 0 && dispatch(AddToCardItems({...data,quantity}))}>
