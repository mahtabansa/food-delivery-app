...
function Navbar() {
      ...
      return (
            <div className="w-full h-[80px] flex items-center justify-between
             md:justify-center gap-[30px] px-[20px]
              fixed top-0 z-[99999] bg-[#fff9f6] overflow-visible">
                  ...
                  {showSearch && <div className='flex flex-row fixed top-[90px] w-[90%] h-[70px] md:hidden lg:hidden 
                  ...
                  <div className='flex items-center gap-[20px]  '>
                      {showSearch? <RxCross1 onClick={()=> setShowSearch(false)}/> :<CiSearch className='flex font-extrabold items-center text-[#ff4d2d] cursor-pointer md:hidden lg:hidden'
            ...
            text-[#ff4d2d]'>My Order</button>
                        <div className='w-[40px] h-[40px] bg-[#ff4d2d] rounded-3xl flex items-center justify-center text-white font-bold text-xl ' onClick={() => setShowInfo(prev => !prev)}>
                        ...
                        rounded-lg bg-white h-[50vh] w-[200px] z-[999999] shadow-lg    '>
                              ...
                              <div className='p-2 text-[#ff4d2d] hover:text-red-500 cursor-pointer text-md font-semibold' onClick={handlelogout}>logout</div>
                        </div>
                        }
                  </div>
