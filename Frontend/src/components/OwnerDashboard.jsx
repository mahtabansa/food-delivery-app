      ...
      return (
            <>
                  ...
                  {!myShopData && <div className="bg-white flex flex-col items-center">
                      ...
                      {myShopData && <div>
                         <h1 className="text-gray-500 font-medium text-xl">wellcome to {myShopData?.name}</h1>

                         <div className=" h-40 w-40 object-cover my-4" >
                              <img src={myShopData?.image} alt=" Restaurant Image" className=" h-40 w-40 object-cover" />
                         </div>
                         </div> }
            </>
      )
